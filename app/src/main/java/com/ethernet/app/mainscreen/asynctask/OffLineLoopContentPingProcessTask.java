...
public class OffLineLoopContentPingProcessTask extends AsyncTask<String, String, String> {

    private static final String TAG = OffLineLoopContentPingProcessTask.class.getSimpleName();
    private DevicePingModel model;
    private String pingId;
    private DatabaseHandler database;

    public OffLineLoopContentPingProcessTask(DevicePingModel devicePingModel , DatabaseHandler db){
        this.model = devicePingModel;
        this.pingId = model.id;
        this.database = db;
    }
    @Override
    ...
    protected void onPostExecute(String s) {
        ...
        if(s.equalsIgnoreCase(Constant.SUCCESS)){
            database.deleteLoopContentById(pingId);
