...
public class OnLineDevicePingAsyncTask extends AsyncTask<Void, Void, String> {

    private static final String TAG = OnLineDevicePingAsyncTask.class.getSimpleName();
    private DevicePingModel model;
    private String jsonResult = Constant.IS_EMPTY;

    private GetOnLineDevicePingListener listener;

    public interface GetOnLineDevicePingListener {
        void didReceivedOneLineDevicePingResult(String status, String json);
    }


    public OnLineDevicePingAsyncTask(GetOnLineDevicePingListener listener, DevicePingModel devicePingModel) {
    ...
    protected String doInBackground(Void... voids) {
        ...
        try {
            ...
            postData += "IsOffline=" + URLEncoder.encode("" + 0, "UTF-8") + "&";
            postData += "OfflineTime=" + URLEncoder.encode("" + 0, "UTF-8");
    ...
    protected void onPostExecute(String status) {
        ...
        if(listener != null){
            listener.didReceivedOneLineDevicePingResult(status,jsonResult);
        }
